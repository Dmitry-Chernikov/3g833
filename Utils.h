...
int main() {
  ...
  converter.setParameter(GROUP_F1, 5,
                         123); // Установка значения для группы F1, параметр 5
  converter.setParameter(GROUP_F2, 3,
                         456); // Установка значения для группы F2, параметр 3
