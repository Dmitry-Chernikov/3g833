...
float getLinearMotion() {
    return angleSensor.linearDisplacementRack(
        angleSensor.absoluteAngleRotation(&absoluteAngle,
                                          angleSensor.rotationRawToAngle(angleSensor.getRawRotation(16, false, true)),
                                          &anglePrevious), normalModule, numberGearTeeth);
}