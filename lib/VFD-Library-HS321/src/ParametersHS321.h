...
public:
     ...
     */
    static Parameter createParameter(const char *name, float defaultValue, const char *unit, float min, float max,
     ...
     */
    static Parameter createParameter(const char *name, int defaultValue, const char *unit, int min, int max,
                                     const char *description);
     ...
     * @return Объект Parameter.
     */
    static Parameter createParameter(const char *name, const char *defaultValue, const char *unit, const char *min,
                                     const char *max, const char *description);
...
private:
    ...
    FaultInfo _faultTable[_faultCount] = {
        ...
        {
            "OU2 (2)", "Перенапряжение во время торможения, Время торможения слишком короткое",
            "Увеличьте время торможения"
        },
        {
            "OU3 (3)", "Перенапряжение на постоянной скорости, Ненормальное входное напряжение",
            "Проверьте входное питание"
        },
        {
            "OCC1 (4)", "Аппаратный перегрузка тока во время разгона, Мощность привода переменного тока низкая",
            "Выберите привод переменного тока с большей мощностью"
        },
        {
            "OCC2 (5)", "Аппаратный перегрузка тока во время торможения, Низкая мощность привода переменного тока",
            "Выберите привод переменного тока с большей мощностью"
        },
        {
            "OCC3 (6)", "Аппаратный перегрузка тока на постоянной скорости, Низкая мощность привода переменного тока",
            "Выберите привод переменного тока с большей мощностью"
        },
        {
            "OCS1 (7)", "Программная перегрузка тока во время разгона, Низкая мощность привода переменного тока",
            "Выберите привод переменного тока с большей мощностью"
        },
        {
            "OCS2 (8)", "Программная перегрузка тока во время торможения, Время торможения слишком короткое",
            "Увеличьте время торможения"
        },
        {
            "OCS3 (9)", "Программная перегрузка тока на постоянной скорости, Ненормальное входное напряжение",
            "Проверьте входное питание"
        },
        ...
        {
            "OU3 (12)", "Перенапряжение на постоянной скорости, Слишком высокое напряжение питания",
            "Проверьте, не слишком ли высокое напряжение питания"
        },
        ...
        {
            "CBC (18)", "Ошибка ограничения тока по волнам, Низкая мощность привода переменного тока",
            "Выберите привод переменного тока с большей мощностью"
        },
        {
            "FBL (19)", "Обратная связь PID ниже нижнего предела, Линия обратной связи PID ослаблена",
            "Проверьте соединение обратной связи"
        },
        {
            "FBH (20)", "Обратная связь PID выше верхнего предела, Проверьте соединение обратной связи",
            "Проверьте соединение обратной связи"
        },
        ...
        {
            "EF (23)", "Внешняя ошибка, Входной терминал внешнего устройства закрыт",
            "Отключите входной терминал внешнего устройства и устраните неисправность"
        },
        {"EPA (24)", "Ошибка настройки параметров", ""},
        {
            "E485 (25)", "Ошибка разъединения связи",
            "Проверьте, не аномально ли соединение линии связи и правильность последовательности линии."
        },
        {
            "SFOC (27)", "Программная перегрузка тока",
            "Настройте время разгона/торможения; если параметры двигателя не совпадают, перенастройте параметры."
        }
    };
};